...
const config = {
  ...
  projectName: 'react-comfort', // Usually your repo name.

  customFields: {
    description: 'React Comfort is a React library that provides utilities for common programming tasks, that make coding in React easier and cleaner.',
    additonalInfo,
  },
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/Ruben-Arushanyan/react-comfort/edit/master/website/',
	  showLastUpdateAuthor: true,
        },
        blog: false,
        // blog: {
        //   blogTitle: 'Blog',
        //   blogDescription: 'React Comfort Blog',
  ...
  themeConfig:
    ...
    ({
      ...
      metadata: [
        {
          name: 'keywords',
          content: 'react, react-comfort, util, utils, utility, utilities, extras, helpers, stdlib, boost',
        },
      ],
      navbar: {
        title: 'React Comfort',
        ...
        items: [
          ...
          // right
          {
            href: 'https://github.com/Ruben-Arushanyan/react-comfort',
            position: 'right',
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'npm',
                href: 'https://www.npmjs.com/package/react-comfort',
              },
            ],
          },
        ],
